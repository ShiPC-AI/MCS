#ifndef _MCS_GROUND_LINEFIT_GROUND_SEGMENTATION_H
#define _MCS_GROUND_LINEFIT_GROUND_SEGMENTATION_H
...
#endif // _MCS_GROUND_LINEFIT_GROUND_SEGMENTATION_H