...
void GroundSegmentation::segment(const PointCloud& cloud, std::vector<int>* segmentation) {
  ...
  /*插入点云数据*/
  // std::cout << "PC:: Start Insert ! " << std::endl; 
  insertPoints(cloud);
  // std::cout << "PC:: Insert ok! " << std::endl; 
  /*定义地面点的线的参数*/
